 ...
 */
abstract class MazeItem extends ProtoObject {
...
abstract class ActiveMazeItem extends MazeItem {
	...
	void SetDirection(int dir) {
		Output ("remark [setdirection] " + Coordinates.DIRS[dir] + " at " + pos);
		changeDirection = dir;
	}
...
class PacMan extends ActiveMazeItem {
	...
	public void OutputInfo() {
		currentMaze.Output("pacman " + mazeItemNumber + " " + pos + " " + Coordinates.DIRS[direction] + " " + bombs);
	}
...
abstract class Monster extends ActiveMazeItem {
	...
	public void Deactivate(long _timeToRebirth) {
		...
		currentMaze.Output("event monster " + mazeItemNumber + " died " + pos);
	}
...
class DumbMonster extends Monster {
	...
	void Decide() {
		...
		currentMaze.Output ("event monster " + mazeItemNumber + " decides " + Coordinates.DIRS[changeDirection]);
	...
	public void OutputInfo() {
		if (isActive())
			currentMaze.Output("monster " + mazeItemNumber + " dumb " + pos + " " + Coordinates.DIRS[direction]);
	}
}
...
//	}
	...
	public void OutputInfo() {
		if (isActive())
			currentMaze.Output("monster " + mazeItemNumber + " clever " + pos + " " + Coordinates.DIRS[direction]);
	}
}
...
class Bomb extends TimedMazeItem {
	...
	public void OutputInfo() {
		currentMaze.Output("bomb " + mazeItemNumber + " " + pos + (active?" active ":" inactive ") + timeToLive);
	}
}
...
class BombBonus extends Bonus {
	...
	public void OutputInfo() {
		currentMaze.Output("bonus " + mazeItemNumber + " " + pos + " bomb " + timeToLive + " " + bombsCount);
	}
...
class ScoreBonus extends Bonus {
	...
	public void OutputInfo() {
		currentMaze.Output("bonus " + mazeItemNumber + " " + pos + " score " + timeToLive + " " + bonusScore);
	}
...
class TimeBonus extends Bonus {
	...
	public void OutputInfo() {
		currentMaze.Output("bonus " + mazeItemNumber + " " + pos + " time " + timeToLive + " " + bonusTime);
	}
...
class Crystal extends MazeItem {
	...
	public void OutputInfo() {
		currentMaze.Output("crystal " + mazeItemNumber + " " + pos);
	}
